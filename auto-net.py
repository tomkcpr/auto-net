...
class AutoNet:
	...
	def loadConf(self,config):
		...
		print("[0] %s" % (self.__yamlConfig.get('autonet',0)))
		print("[1] %s" % (self.__yamlConfig.keys()))
		print("[2] %s" % (self.__yamlConfig.get("autonet")))
		...
		print(json.dumps(self.__yamlConfig.values()))
