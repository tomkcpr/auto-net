...
class AutoNet:
	...
	def loadConf(self,config):
		...
		print(self.__yamlConfig.get('autonet',0))
		print(self.__yamlConfig.keys())
		print(self.__yamlConfig.get("autonet"))
		print(self.__yamlConfig.get("ipa"))
		print(self.__yamlConfig.get("autonet.ipa"))
